@file:JvmName("PreferenceDatabindingHelper")
...
private inline fun <T> Preference<T>.connectTo(
...
class PreferenceBinding<T>(private val observable: Observable,
                           ...
                           private val connection: Preference.Connection<T>) : Preference.Disposable {
